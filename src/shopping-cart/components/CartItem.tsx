...
export const CartItem = ({ product, quantity }: Props) => {
  ...
  return (
    <div className="flex items-center shadow rounded-lg h-full w-full p-2 bg-gray-800">
      {/* Product Image */}
      <div>
        <Image
          width={200}
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mr-1">
        <button
          onClick={onAddToCart}
          className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
